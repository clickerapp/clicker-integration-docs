...
- <details markdown="1"> 
  ...
  ![Пример элемента Clicker на странице "Карточка товара".](/integration-docs/images/1.___ver2_22_06_2020.png)
  ...
  ![Пример модального pop-up окна Clicker на странице "Корзина"](/integration-docs/images/Untitled.png)
...
- <details markdown="1"> 
  ...
  ![Пример страницы с iframe Clicker](/integration-docs/images/img-2021-10-28-10-48-51.png)
