...
> ☝ Помимо интеграции по API вы также можете [установить готовый виджет на сайт](/docs/widgets)
...
| city                   | String                       | Город создания заказа. См. <a href="/docs/widgets/#Goroda">список доступных городов</a>                                                                            | Yes          |
| clientsFullName        | String                       | ФИО клиента                                                                                                                                                        | Yes          |
| clientsAddress         | String                       | Адрес доставки и оказания услуг                                                                                                                                    | Yes          |
| clientsPhone           | String                       | Мобильный телефон клиента в формате +7... 7... 8... или 9... только цифры, без пробелов, дефисов, скобок и других разделителей                                     | Yes          |
...
### Описание структуры массива includedServicesCustom
...
| Name       | Тип    | Описание                                                          | Обязательный |
| ---------- | ------ | ----------------------------------------------------------------- | ------------ |
| vendorCode | String | Артикул (обязательно должно быть уникальным в конкретном запросе) | Yes          |
...
| Название               | Тип                                                                                                                                                                                                                                                                                                                                                                | Описание                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| city                   | String                                                                                                                                                                                                                                                                                                                                                             | Город создания заказа. См. <a href="/docs/widgets/#Goroda">список доступных городов</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| clientsPhone           | String                                                                                                                                                                                                                                                                                                                                                             | Мобильный телефон клиента без +7/8, а также без пробелов, дефисов, скобок и других разделителей, т.е. просто 10 цифр.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| clientPageUrl          | String                                                                                                                                                                                                                                                                                                                                                             | Ссылка на страницу заказа для клиента (не требующую авторизации)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
```
GET https://api.clicker.one/v1/prices?api_key=xXxxxxXXxxxxxxxxxxxxxxxxxxxxxxxxx&page=2&limit=20
```
...
```
GET https://api.clicker.one/v1/departments?api_key=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
```
...
## Получение списка доступных услуг для города
...
**city** [обязательно должен быть либо city, либо lon & lat] - Город, см. <a href="/docs/widgets/#Goroda">список доступных городов</a>

**lon** [обязательно должен быть либо city, либо lon & lat] - примерная долгота географической точки предполагаемой установки услуги

**lat** [обязательно должен быть либо city, либо lon & lat] - примерная широта географической точки предполагаемой установки услуги

**Пример body запроса:**

```text
GET https://api.clicker.one/v1/services?shopId=superShop&lat=55.371636&lon=38.111952
```
...
**includedWorks** - массив строк, работы, которые включены в стоимость; может быть пустым

**notIncludedWorks** - массив строк, работы, которые не включены в стоимость; может быть пустым

**priceForCustomer** - цена для покупателя

**category** - название категории услуги
...
```json
{
  ...
  "data": {
    "services": [
      {
        "id": "1598554779593x959712834011529200",
        "title": "Подключение и настройка PlayStation или Xbox",
        "description": "Подключение и настройка Playstation / Xbox",
        "includedWorks": [],
        "notIncludedWorks": [],
        "priceForCustomer": 2000,
        "category": "Телевизоры и аудио техника"
      },
      {
        "id": "1614773317479x331407246072741900",
        "title": "Установка встраиваемой кофемашины",
        "description": "Распакуем и встроим кофемашину в подготовленное место, подключим к электросети и проверим работоспособность",
        "includedWorks": [
          "Выезд специалиста в пределах границы города (для г. Москва выезд в пределах МКАД)",
          "Распаковка и визуальный осмотр техники",
          "Консультация по вопросам эксплуатации",
          "Установка на место дальнейшей эксплуатации (в мебельную нишу)",
          "Подключение к существующей точке электроснабжения, без доработки",
        ...
        "priceForCustomer": 3400,
        "category": "Встраиваемые кофемашины"
      }
      // ...
    ],
    "longDistanceTripService": {
      "id": "1601480230080x608378112468844500",
      "title": "Выезд за МКАД (за 1 км)",
      "description": "Мастера выезжают в пределах 50 км от МКАД, в том числе в Зеленоград, Солнечногорск, Химки, Долгопрудный, Лобню, Пушкино, Мытищи, Щёлково, Балашиху, Реутов, Люберцы, Видное.",
      "includedWorks": [],
      "notIncludedWorks": [],
      "priceForCustomer": 45,
      "category": "Выезд за границу города — Москва"
    }
  }
}
```
...
**city** [обязательно должен быть либо city, либо geoPosition] - Город, см. <a href="/docs/widgets/#Goroda">список доступных городов</a>
...
**matchProperties** [обязательно] - массив, набор параметров, по которым будет происходить поиск подходящей услуги, <a href="/docs/widgets/#Pravila-sopostavleniya-tovar-usluga">подробнее о сопоставлении</a>. Экземпляр массива состоит из:
...
## 🕙 История версий
 ...
 <details> 
  	<summary>1.22, 30.03.2023</summary> 
  	- Эндпоинт получения услуг (/services), рабочая версия<br/>
  	- В ответ получения данных по заказам добавлено поле clientPageUrl
  </details>
