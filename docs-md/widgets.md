...
- <details> 
  ...
  ![Пример элемента Clicker на странице "Карточка товара".](1.___ver2_22_06_2020.png)
  ...
  ![Пример модального pop-up окна Clicker на странице "Корзина"](Untitled.png)
...
- <details> 
  ...
  ![Пример страницы с iframe Clicker](img-2021-10-28-10-48-51.png)
